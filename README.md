...
* With Heroku:
  ...
  * First click [**this**](https://heroku.com/deploy?template=https://github.com/Eversterm/Userge/tree/master)
  * Fill `API_ID`, `API_HASH`, `DATABASE_URL` and `LOG_CHANNEL_ID` (**required**)
  * Choose your [**MODE**](https://github.com/Eversterm/Userge#userge-modes-)
